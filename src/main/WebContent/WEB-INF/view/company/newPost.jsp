...
<c:if test="${addMessage != 'null'}">
    ...
    <c:if test="${addMessage == 'failed'}">
        ...
        <script>
            swal({
                title: 'Đăng tuyển không thành công!',
                icon: 'error',
                timer: 3000,
                buttons: true,
                type: 'error'
...
<section class="site-section">
    <div class="container">
    <form:form action="${pageContext.request.contextPath}/company/addRecruitment" method="post" modelAttribute="recruitmentModel">
            ...
            <div class="col-lg-12">
                <div class="p-4 p-md-5 border rounded" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <form:input type="text" cssClass="form-control" id="email" path="title" placeholder="Tiêu đề"></form:input>
                        <form:errors cssClass="text-danger" path="title"></form:errors>
                    </div>
                    <div class="form-group">
                        <label for="job-location">Mô tả công việc</label>
                        <form:textarea path="description" cssClass="form-control" id="editorN" placeholder="Mô tả"></form:textarea>
                    </div>
                    <div class="form-group">
                        <label for="job-title">Kinh nghiệm</label>
                        <form:input type="text" cssClass="form-control" id="job-title" path="experience" placeholder="Kinh nghiệm"></form:input>
                    </div>
                    
                    <div class="form-group">
                        <label for="job-title">Số người cần tuyển</label>
                        <form:input type="number" cssClass="form-control" id="job-title" path="quantity" placeholder="Số người cần tuyển"></form:input>
                        <form:errors cssClass="text-danger" path="quantity"></form:errors>
                    </div>
                    <div class="form-group">
                        <label for="job-location">Địa chỉ</label>
                        <form:input type="text" cssClass="form-control" id="job-location"  path="address" placeholder="Địa chỉ công ty"></form:input>
                    </div>
                    <div class="form-group">
                        <label for="job-location">Hạn ứng tuyển</label>
                        <form:input type="date" cssClass="form-control" id="job-location" path="deadline" placeholder="Hạn ứng tuyển"></form:input>
                    </div>
                    <div class="form-group">
                        <label for="job-location">Lương</label>
                        <form:input type="text" cssClass="form-control" id="job-location"  path="salary" placeholder="Mức lương"></form:input>
